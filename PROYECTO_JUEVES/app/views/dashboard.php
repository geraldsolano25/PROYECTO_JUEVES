...
<div class="container py-2">
    ...
    <div class="card shadow-sm mb-4" id="reportar">
        <div class="card-body">
            ...
            <form method="POST" action="../controllers/IncidenteController.php" class="row g-3">
                ...
                <div class="col-md-4"><input type="text" class="form-control" name="ubicacion" placeholder="Ubicación" required></div>
                <div class="col-md-4"><input type="text" class="form-control" name="distrito" placeholder="Distrito" required></div>
                <div class="col-md-4"><input type="text" class="form-control" name="canton" placeholder="Cantón" required></div>
                <div class="col-md-4"><input type="text" class="form-control" name="provincia" placeholder="Provincia" required></div>
